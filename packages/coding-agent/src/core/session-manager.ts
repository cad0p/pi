...
import type { CacheMiss } from "./cache-stats.ts";
import {
...
export interface BranchSummaryEntry<T = unknown> extends SessionEntryBase {
	 ...
	 * Display metadata only: derived from the measured response usage at
	 * generation time, never fed back into billed-token accounting.
	 */
	cacheMiss?: CacheMiss;
